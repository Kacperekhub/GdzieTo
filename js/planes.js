async function pobierzSamoloty() {
    ...
    try {
        ...
        if (tekst.trim().startsWith("<")) {
            console.warn("Samoloty: Proxy przeciążone.");
            return;
        }
                ...
                if (lat && lon) {
                    L.marker([lat, lon], {
                        icon: L.divIcon({
                            ...
                            html: `<div style="transform: rotate(${samolot[10] || 0}deg)"><svg width="20" height="20" viewBox="0 0 24 24"><path d="M21,16L21,14L13,9L13,3.5A1.5,1.5 0 0,0 11.5,2A1.5,1.5 0 0,0 10,3.5L10,9L2,14L2,16L10,13.5L10,18L8,19.5L8,21L11.5,20L15,21L15,19.5L13,18L13,13.5L21,16Z" fill="#ffce00"/></svg></div>`
                        })
    ...
    } catch (e) { console.warn("Problem z samolotami."); }
}
pobierzSamoloty();
